...
class ListingController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'tbphoto' => ['nullable', 'image', 'mimes:jpeg,png,jpg'],
            'hallphoto' => ['nullable', 'image', 'mimes:jpeg,png,jpg'],
            'kitchenphoto' => ['nullable', 'image', 'mimes:jpeg,png,jpg'],
            'psphoto' => ['nullable', 'image', 'mimes:jpeg,png,jpg'],
            'froom' => ['nullable', 'image', 'mimes:jpeg,png,jpg'],
            'sroom' => ['nullable', 'image', 'mimes:jpeg,png,jpg'],
            'info' => 'required',
            'rules' => 'required',
